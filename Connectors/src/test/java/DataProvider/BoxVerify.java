...
public class BoxVerify extends BrowserSelection {
	...
	public void boxConnectorVerify() throws InterruptedException {
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath(
				"//img[@src='//du15km6j44b3f.cloudfront.net/static-assets/js/language-cloud/200ec776a5adc0285636d611df5b59ae.svg']")));
		bP.getconnector().click();
		Thread.sleep(5000);
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//*[text()='Box Configuration' and @class='action-link']")));
		...
		wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//div[@class=' x-tree-elbow-img x-tree-elbow-plus x-tree-expander']")));
		bP.getselectfolder();
		Thread.sleep(5000);
		wait.until(ExpectedConditions.visibilityOfElementLocated(
				By.xpath("//*[@class=' x-tree-elbow-img x-tree-elbow']//following-sibling::div")));
		bP.getselectfile();
		...
		wait.until(ExpectedConditions
				.visibilityOfElementLocated(By.xpath("//span[@unselectable='on' and text()='Files']")));
		...
		for (int i = 0; n2.isEmpty(); i++) {
			...
			if (n4.isEmpty() == false) {
				...
				wait.until(ExpectedConditions
						.visibilityOfElementLocated(By.xpath("//*[@class='notification-container']/div/div/p")));
		...
		if (n5.isEmpty()) {
			logger.log(Status.INFO, "File not Imported");
		} else {
			logger.log(Status.INFO, "File Imported to Box Successfully done");
		}

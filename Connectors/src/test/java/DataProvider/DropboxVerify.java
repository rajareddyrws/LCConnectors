...
public class DropboxVerify extends BrowserSelection{
	...
	public void dropboxConnectorVerify() throws IOException, AWTException, InterruptedException {
        ...
        //selecting the file
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//*[@id='dataView']/div[1]/div")));
        gD.getconnector().click();
        wait.until(ExpectedConditions.visibilityOfElementLocated(By.xpath("//[text()='Select Dropbox configuration']/../../../../.. //[text()='Dropbox Configuration _ Testing']")));
